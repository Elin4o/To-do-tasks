...
namespace ToDoTask {
    ...
    public partial class TasksDataSet : global::System.Data.DataSet {
        ...
        public partial class TasksDataTable : global::System.Data.TypedTableBase<TasksRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
            public TasksRow AddTasksRow(int Id, string Task, System.DateTime Date) {
...
namespace ToDoTask.TasksDataSetTableAdapters {
    ...
    public partial class TasksTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = "DELETE FROM [dbo].[Tasks] WHERE (([Id] = @Original_Id) AND ([Task] = @Original_Ta" +
                "sk) AND ([Date] = @Original_Date))";
            ...
            this._adapter.InsertCommand.CommandText = "INSERT INTO [dbo].[Tasks] ([Id], [Task], [Date]) VALUES (@Id, @Task, @Date);\r\nSEL" +
                "ECT Id, Task, Date FROM Tasks WHERE (Id = @Id)";
            ...
            this._adapter.UpdateCommand.CommandText = "UPDATE [dbo].[Tasks] SET [Id] = @Id, [Task] = @Task, [Date] = @Date WHERE (([Id] " +
                "= @Original_Id) AND ([Task] = @Original_Task) AND ([Date] = @Original_Date));\r\nS" +
                "ELECT Id, Task, Date FROM Tasks WHERE (Id = @Id)";
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT Id, Task, Date FROM dbo.Tasks";
